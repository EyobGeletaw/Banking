...
public void deposit(String fromUsername, double amount) {
        Client client = findClients(fromUsername);
        if (client!=null){
            client.getAccount().Deposit(amount);
            Transactions t = new Transactions("Deposit","Bank",fromUsername,amount);
            transactions.add(t);
}
}
    import java.util.ArrayList;
...
public void withdraw(String fromUsername, double amount) {
        Client client = findClients(fromUsername);
        if (client!=null){
            client.getAccount().Withdraw(amount);
            Transactions t = new Transactions("Withdraw",fromUsername,"",amount);
            transactions.add(t);
        }
}
}
